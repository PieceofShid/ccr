...
Route::prefix('block')->group(function(){
    ...
    Route::get('/{date}/check', [BlockController::class, 'check'])->name('block.check');
...
Route::prefix('crank')->group(function(){
    ...
    Route::get('/{date}/check', [CrankController::class, 'check'])->name('crank.check');
...
Route::prefix('head')->group(function(){
    ...
    Route::get('/{date}/check', [HeadController::class, 'check'])->name('head.check');
...
Route::prefix('cam')->group(function(){
    ...
    Route::get('/{date}/check', [CamController::class, 'check'])->name('cam.check');
...
Route::prefix('assy')->group(function(){
    ...
    Route::get('/{date}/check', [AssyController::class, 'check'])->name('assy.check');
