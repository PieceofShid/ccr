              ...
              <div class="col-12 col-md">
                <div class="form-group row">
                  ...
                  <div class="col-12 col-md d-flex justify-content-between align-items-center">
                    ...
                    <span class="d-none d-md-block ml-2">unit</span>
                  </div>
                </div>
                <div class="form-group row">
              ...
              <div class="col">
                <div class="form-group row">
                  ...
                  <div class="col-12 col-md d-flex justify-content-between align-items-center">
                    ...
                    <span class="ml-2 d-none d-md-block">Minute</span>
                  </div>
                </div>
              </div>
              <div class="col">
                <div class="form-group row">
                  ...
                  <div class="col-12 col-md d-flex justify-content-between align-items-center">
                    ...
                    <span class="ml-2 d-none d-md-block">Jam</span>
                  </div>
                </div>
              </div>
            </div>
...
@section('script')
    <script>
      ...
      function checkData(){
        ...
        var tipe = $('#tipe').val();
        var url = "{{ route('head.check', [":date", ":tipe"])}}";
